 ...
 *
 */
var View = Backtree.View = Backbone.View.extend({
 ...
 */
var FooterView = Backtree.FooterView = Backtree.View.extend({
  tagName: "footer",
  template: _.template('\
    <nav class="right">\
    <ul class="menu">\
...
var TreeView = Backtree.TreeView = Backtree.View.extend({
  /*  Main Tree View 
   *  Represents a tree.
   *  
...
var NodeView = Backtree.NodeView = Backtree.TreeView.extend({
